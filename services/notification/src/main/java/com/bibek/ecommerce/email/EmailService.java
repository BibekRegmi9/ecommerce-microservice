package com.bibek.ecommerce.email;

import com.bibek.ecommerce.kafka.order.Product;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail,
        ...
        mimeMessageHelper.setFrom("bibek@gmail.com");
        ...
        try {
            ...
            log.warn("Warning - cannot send email to %s ", destinationEmail);
        }
    }
